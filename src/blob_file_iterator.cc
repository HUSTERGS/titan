...
namespace rocksdb
{
    namespace titandb
    {
        ...
        // 获取当前offset对应的blob record，并将结果保存在cur_blob_record_当中
        ...
        // 大概就是不断调整readahead_begin_offset以及readahead_end_offset以及readahead_size来决定预读取的数据，然后调用GetBlobRecord来获得当前的blob记录
